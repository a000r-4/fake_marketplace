...
mixin _$ProductModel {
  ...
  String get image =>
      throw _privateConstructorUsedError; // В Fake API рейтинг приходит как объект { "rate": 3.9, "count": 120 }
...
class _$ProductModelImpl implements _ProductModel {
  const _$ProductModelImpl({
    ...
    required this.image,
    required final Map<String, dynamic> rating,
  }) : _rating = rating;
...
abstract class _ProductModel implements ProductModel {
  ...
  String get category;
  @override
  String get image; // В Fake API рейтинг приходит как объект { "rate": 3.9, "count": 120 }
  // Мы можем либо создать отдельную модель для рейтинга, либо упростить:
  @override
  Map<String, dynamic> get rating;
