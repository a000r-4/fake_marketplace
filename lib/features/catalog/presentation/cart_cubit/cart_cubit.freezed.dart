...
mixin _$CartState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CartItemEntity> items, double totalPrice)
        success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CartItemEntity> items, double totalPrice)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CartItemEntity> items, double totalPrice});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(
      {required final List<CartItemEntity> items, this.totalPrice = 0.0})
      : _items = items;
  ...
  @override
  String toString() {
    return 'CartState.success(items: $items, totalPrice: $totalPrice)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(items, totalPrice);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(items, totalPrice);
  }
...
abstract class _Success implements CartState {
  const factory _Success(
      ...
      final double totalPrice}) = _$SuccessImpl;
