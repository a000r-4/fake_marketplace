...
import '../../features/catalog/data/datasource/firebase_cart_service.dart';
...
Future<void> initDependencies () async {
  ...
  getIt.registerLazySingleton<FirebaseCartService>(() => FirebaseCartService());
  // Catalog
  ...
  getIt.registerLazySingleton<AuthRepo>(
        () => FirebaseAuthRepoImpl(
            getIt<FirebaseAuthRemoteDataSourceAbst>(),
            getIt<FirebaseCartService>()
        ),
  );
  getIt.registerFactory<CatalogCubit>(
        () => CatalogCubit(getIt()),
  );
  getIt.registerFactory<PurchaseHistoryCubit>(
        () => PurchaseHistoryCubit(getIt()),
  );
  ...
  getIt.registerFactory<CartCubit>(
        () => CartCubit(firebaseService:getIt<FirebaseCartService>(),),
  );
}